 ...
 */
public class IncrementalMedian<IN> extends IncrementalOperation<IN> {


    private static final long serialVersionUID = 1L;

    public IncrementalMedian(IncrementalConfiguration configuration) {
        super(configuration, new StatefulMedian());
    }
