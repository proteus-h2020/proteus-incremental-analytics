...
import com.treelogic.proteus.core.incops.statistics.IncrementalPearsonCorrelation;
import com.treelogic.proteus.examples.pojos.AirRegister;
...
public class PearsonExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        stream
            ...
            .apply(new IncrementalPearsonCorrelation<AirRegister>(configuration))            
            .print();
